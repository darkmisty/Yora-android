...
public class MessageActivity extends BaseAuthenticatedActivity implements View.OnClickListener {
    ...
    protected void onSocialCreate(Bundle savedState) {
        ...
        drawer = findViewById(R.id.activity_message_show_drawer);
        ...
        longMessage = (TextView) findViewById(R.id.activity_message_long_message);
    ...
    @Subscribe
    public void onMessageDetailsLoaded(final Messages.GetMessageDetailsRespons response) {
    ...
    private void showMessage(Message message) {
        ...
        if (!message.isRead()) {
            bus.post(new Messages.MardMessageAsReadRequest(message.getId()));
        }
    }
